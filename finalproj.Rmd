...
to in all datasets will be the common variables that allows us to merge it all into one. For all of the 
...
code and a year of data on file. This allows us to keep the most data possible from out different sets as 
...
how the leading countries in each region compare to each other as Australia, Brazil, China, Russia, and 
Nigeria all have the highest populations in their respective countries. All the other plots we created use 
